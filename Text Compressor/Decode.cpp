...
void print2DUtil(leaf *root, int space=0)  
{  
    // Base case  
    if (root == NULL)  
        return;  
...
//	ifstream BinFile("C:/Users/Rakesh/Desktop/HtmlProjects/DS Lab Work/HuffmanString.txt");
//	ifstream InfoFile("C:/Users/Rakesh/Desktop/HtmlProjects/DS Lab Work/ProjectTry.txt");
...
//	cout<<BinString<<endl;
//	treePreorder = string(treePreorder);
//	string s = arrToString(arr, sizeof(arr)/sizeof(arr[0]));
